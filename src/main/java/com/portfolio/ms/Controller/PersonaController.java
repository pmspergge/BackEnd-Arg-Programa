...
import com.portfolio.ms.Service.ImpPersonaService;
...
@CrossOrigin(origins = {"https://frontendargprograma-e695a.web.app","http://localhost:4200"})
    ...
    */
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtoeducacion){
        ...
        Persona persona = new Persona(
                dtopersona.getNombreE(), dtopersona.getDescripcion()
            );
